// Cloudflare Pages Function — runs on Cloudflare's edge Workers runtime, not
// as a Next.js API route. This site is statically exported (next.config.ts
// sets output: "export"), so it cannot ship Next.js Route Handlers; dynamic
// endpoints live here in functions/api/* instead (same pattern as contact.ts).
//
