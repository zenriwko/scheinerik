  ...
  return (
    <section className={styles.section}>
      <div className={`container ${styles.inner}`}>
        ...
        <h3>Proč Hvězdné Nebe Působí Pozitivně na Tělo i Mysl</h3>
        ...
        <ol className={styles.list}>
          <li>
            <h4>Snížení stresu a úzkosti</h4>
            <p>
          ...
          <li>
            <h4>Podporuje kreativitu a inspiraci</h4>
            <p>
